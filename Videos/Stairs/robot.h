...
public:
	...
	void Label(class NEURAL_NETWORK *genome);
...
private:
	...
	void Neural_Network_Set_Sensor_Neurons(void);
	void Neural_Network_Set_Sensor_Neurons_In_Joints(
		int *sensorIndex);
	void Neural_Network_Set_Sensor_Neurons_In_Objects(
		int *sensorIndex);
	void Neural_Network_Update(void);
