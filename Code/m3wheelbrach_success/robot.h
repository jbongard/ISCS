...
private:
	...
	void Create_Wheel(void);
	void Create_Wheel_Add_Foot(      double x, double y, double z,
					 double angle,
					 int *currObject);
	void Create_Wheel_Add_Foot_Joint(double x, double y, double z,
					 double angle,
					 int *currObject);
	void Create_Wheel_Add_Joint(     double x, double y, double z,
				         double angle, int segIndex,
					 int *currObject, int legBase);
	void Create_Wheel_Add_Leg_Seg(	 double x, double y, double z,
					 double angle, int segIndex,
					 int *currObj, int legBase);
	void Create_Wheel_Joints(void);
	void Create_Wheel_Objects(void);
